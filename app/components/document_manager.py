...
def render_document_manager(
    ...
    """
    Render document manager component for RAG functionality.
    ...
    try:
        ...
        st.error(f"Error initializing document manager: {str(e)}")
        st.info("Please check your RAG system configuration.") 